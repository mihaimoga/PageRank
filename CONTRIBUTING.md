...
***Ask not what WebSearchEngine can do for you - ask what you can do for WebSearchEngine***
...
2. Include additional information such as:
    ...
    * WebSearchEngine Debug-Info containing:
      * Operating System version
      * WebSearchEngine version
...
1. Respect existing WebSearchEngine coding style. Observe the code near your intended change, and attempt to preserve the style of that code with the changes you make.
